...
declare namespace ns_0 {
  ...
  import IFilterSpec = __beyond_dep_ns_1.IFilterSpec;
...
declare namespace ns_1 {
  ...
  export class _default extends FilesArray {
     ...
     * @returns {FileData | undefined} Returns the file if it passes the filter, otherwise undefined.
     */
    push(file: FileData | string, sort?: boolean): FileData;
  }
}
...
declare namespace ns_5 {
   ...
   * @returns {function*}
   */
  export function _default(includes: IFilterSpec['includes'], inclusions: Map<string, Inclusion>): () => Generator<__beyond_dep_ns_0.ns_0.FileData, void, unknown>;
}
...
declare namespace ns_7 {
   ...
   */
  export function _default(path: string, specs: IFilterSpec): IFilterSpec;
}
